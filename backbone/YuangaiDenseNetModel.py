...
class _Transition(nn.Sequential):
    def __init__(self,
        ...
        self.add_module("conv", nn.Conv2d(input_c,
                                          ...
                                          stride=1,
                                          bias=False))
        self.add_module("pool", nn.AvgPool2d(kernel_size=2, stride=pool_stride))
...
class DenseNet(nn.Module):
    ...
    def __init__(self,
                 ...
                 memory_efficient: bool = False,
                 transition_strides: Tuple[int, ...] = (2, 2, 2)):
        ...
        for i, num_layers in enumerate(block_config):
            ...
            if i != len(block_config) - 1:
                trans = _Transition(input_c=num_features,
                                    ...
                                    pool_stride=transition_strides[i])
...
def densenet121yuangai(**kwargs: Any) -> DenseNet:
    # Top-1 error: 25.35%
    # 'densenet121': 'https://download.pytorch.org/models/densenet121-a639ec97.pth'
    return DenseNet(growth_rate=32,
                    block_config=(19, 25, 25),
                    num_init_features=32,
                    transition_strides=[1, 2],
                    **kwargs)
